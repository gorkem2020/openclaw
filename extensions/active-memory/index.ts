...
function buildRecallSystemPrompt(params: { config: ResolvedActiveRecallPluginConfig }): string {
  ...
  const defaultInstructions = [
    ...
    "1. NONE",
    "Use NONE when nothing clearly useful was found, or when the connection is weak, broad, or vague.",
    `2. One compact plain-text summary, under ${params.config.maxSummaryChars} characters.`,
